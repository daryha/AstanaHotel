	...
	const fetchUserProfile = async () => {
		try {
			...
			const response = await axios.get(
				'https://tasty-priority-server-1482c4db125b.herokuapp.com/api/user/profile/',
				{
					headers: {
		...
		try {
			...
			if (!isAdded) {
				...
				response = await axios.post(
					`https://tasty-priority-server-1482c4db125b.herokuapp.com/api/cart/add/${id}/`,
					{},
					{
						headers: {
							Authorization: `Token ${token}`,
				...
				response = await axios.delete(
					`https://tasty-priority-server-1482c4db125b.herokuapp.com/api/cart/remove/${id}/`,
					{
						headers: {
							Authorization: `Token ${token}`,
						},
